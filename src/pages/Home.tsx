...
export function Home() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-blur bg-cover bg-no-repeat">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-2 w-full">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 bg-green-500 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-all disabled:opacity-50"
            >
              Garantir minha vaga
            </button>
          </form>
      ...
      <img className="mt-10" src={mockUpImg} alt="" />
    </div>
  );
}
